...
function Account() {
    ...
    const fetchAccount = async () => {
        ...
        if (accountData && accountData.dob) {
            ...
            {account && (
                <form>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" value={account.username} readOnly />
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        ...
                        <select className="form-select" value={account.role} onChange={(e) => setAccount({ ...account, role: e.target.value })}>
                    ...
                    <button className="btn btn-danger w-100" onClick={signout}>Sign out</button>
                </form>
            )}
            <Link to="/project/admin/users" className="btn btn-warning w-100 mt-2">Users</Link>
        </div>
    );
}
